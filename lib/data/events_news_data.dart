...
List<PiligrimEvent> buildMockEvents() {
  ...
  return [
    ...
    PiligrimEvent(
      ...
      format: EventAccessFormat.open,
      coverAssetPath: PiligrimInteriorAssets.allInteriorPngs[3],
      priceFromRub: null,
    ),
    PiligrimEvent(
      id: 'p1',
      ...
      format: EventAccessFormat.open,
      coverAssetPath: PiligrimInteriorAssets.allInteriorPngs[4],
      priceFromRub: 12000,
      isPast: true,
      hasPhotoReport: true,
    ),
    PiligrimEvent(
      ...
      format: EventAccessFormat.closed,
      coverAssetPath: PiligrimInteriorAssets.allInteriorPngs[5],
      priceFromRub: null,
      isPast: true,
      hasPhotoReport: true,
    ),

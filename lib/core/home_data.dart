...
// ─────────────────────────────────────────────────────────────────────────────
// Hero-заголовок (статичный — раньше ротировались 3 фразы, теперь один текст)
// ─────────────────────────────────────────────────────────────────────────────
const kHeroTitle = 'Вкус жизни.\nПуть героя.';

// Фолбэк-продолжение текста ниже заголовка (RU), если поле "Описание концепции"
// в админке (RestaurantInfo.concept_description) пустое. Используется и на
// сплэше (после kHeroTitle), и на главном экране (после статичного заголовка) —
// само по себе заголовок не повторяет, чтобы не дублироваться на главном экране.
const kModernNomadConcept =
    'У жизни есть вкус, а у вкуса есть история. Чтобы взглянуть на жизнь '
    'по-новому, достаточно погрузиться в прошлое и пройти гастрономическое '
    'паломничество в настоящее.';

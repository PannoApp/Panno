...
Принимает `callback_query` от Telegram при нажатии inline-кнопок. CSRF-exempt, защищён заголовком `X-Telegram-Bot-Api-Secret-Token` (если задан `TELEGRAM_WEBHOOK_SECRET`).
